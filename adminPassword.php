                ...
                <div class="w3-container w3-padding">
                    ...
                    <div class="w3-center">
                        <button class="w3-button w3-indigo w3-hover-indigo w3-large"
                                onclick="javascript:location.href='adminhome.php'">Back
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="w3-modal" id="errorMsg" style="display: block">
            <div class="w3-modal-content w3-display-middle w3-mobile">
                <div class="w3-container w3-padding">
                    ...
                    <div class="w3-center">
                        <button class="w3-button w3-indigo w3-hover-indigo w3-large" onclick="javascript:location.href='adminhome.php'">Back</button>
                    </div>
                </div>
            </div>
        </div>
