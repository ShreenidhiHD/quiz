...
<div class="w3-right">
    <button class="w3-button w3-margin-bottom w3-orange" onclick="javascript:location.href='userhome.php'">Back</button>
    ...
    <table class="w3-table-all">
        ...
        while ($getqu=mysqli_fetch_assoc($getq)) {
            ...
            <tr>
                ...
                <td><a href="userrankviewdisplay.php?qdate=<?php echo $getqu["date"]; ?>">View</a></td>
            </tr>
            <?php
        }
        ?>
