    ...
    <div class="w3-container w3-card-4">
        <form method="get">
            ...
            while ($getquizaa=mysqli_fetch_assoc($getquizq)){
                ...
                <p>
                    <input name="aid[]" hidden readonly value="<?php echo $getquizaa["aid"]; ?>">
                    <input name="qid" hidden readonly value="<?php echo $_REQUEST["q"]; ?>">
                    <input class="w3-check a-<?php echo $getquizaa["aid"]; ?>" type="checkbox" hidden checked id="a" name="a[]" value="0" />
                    <input class="w3-check a-<?php echo $getquizaa["aid"]; ?>" type="checkbox" id="a" name="a[]" value="a" />
                    <label><?php echo $getquizaa["answera"];?></label></p>
                <p>
                    <input class="w3-check a-<?php echo $getquizaa["aid"]; ?>" type="checkbox" id="a" name="a[]" value="b" />
                    <label><?php echo $getquizaa["answerb"];?></label></p>
                <p>
                    <input class="w3-check a-<?php echo $getquizaa["aid"]; ?>" type="checkbox"  id="a" name="a[]" value="c"/>
                    <label><?php echo $getquizaa["answerc"];?></label></p>
                <p>
                    <input class="w3-check a-<?php echo $getquizaa["aid"]; ?>" type="checkbox"  id="a" name="a[]" value="d" />
                    <label><?php echo $getquizaa["answerd"];?></label></p>
            ...
            ?>
            <p class="w3-center"> <button type="button" class="w3-button w3-margin-bottom w3-indigo" onclick="location.href='uploaderhome.php'">Goback</button></p>
        </form>
    </div>
</div>
</body>
